...
db_tables_data = [
    ...
    ['users', 'role', 'VARCHAR(50)', 'NOT NULL', 'Admin, Manager, Contractor, Subcontractor, or User'],
...
page_db_data = [
    ...
    ['UserDashboard.html', 'User/Subcontractor main dashboard', '', '', 'Subcontractor, User'],
...
role_data = [
    ['Feature/Page', 'Admin', 'Manager', 'Subcontractor', 'User', 'Notes'],
    ['Login', 'Yes', 'Yes', 'Yes', 'Yes', 'Public access'],
    ['Signup', 'Yes', 'Yes', 'Yes', 'Yes', 'Public access'],
    ['Admin Dashboard', 'Yes', 'No', 'No', 'No', 'Admin only'],
    ['Manager Dashboard', 'Yes', 'Yes', 'No', 'No', 'Managers and Admins'],
    ['User Dashboard', 'No', 'No', 'Yes', 'Yes', 'Subcontractors and Users'],
    ['Manage Users', 'Yes', 'No', 'No', 'No', 'Full CRUD - Admin only'],
    ['Approve Pending Users', 'Yes', 'No', 'No', 'No', 'Admin only'],
    ['View Properties', 'Yes', 'Yes', 'Yes', 'Yes', 'All roles'],
    ['Add/Edit Properties', 'Yes', 'Yes', 'No', 'No', 'Admin and Manager'],
    ['Delete Properties', 'Yes', 'Yes', 'No', 'No', 'Admin and Manager'],
    ['Bulk Import Properties', 'Yes', 'Yes', 'No', 'No', 'Admin and Manager'],
    ['Submit Winter Logs', 'Yes', 'Yes', 'Yes', 'Yes', 'All roles'],
    ['View Winter Logs', 'Yes', 'Yes', 'Yes', 'Yes', 'All roles'],
    ['Submit Green Services Logs', 'Yes', 'Yes', 'Yes', 'Yes', 'All roles'],
    ['View Green Services Logs', 'Yes', 'Yes', 'Yes', 'Yes', 'All roles'],
    ['Manage Equipment Rates', 'Yes', 'Yes', 'No', 'No', 'Admin and Manager'],
    ['View Equipment Rates', 'Yes', 'Yes', 'Yes', 'Yes', 'All roles (pricing hidden for User/Subcontractor)'],
    ['Delete Equipment Rates', 'Yes', 'No', 'No', 'No', 'Admin only'],
    ['Manage Winter Products', 'Yes', 'Yes', 'No', 'No', 'Admin and Manager'],
    ['Manage Landscape Products', 'Yes', 'No', 'No', 'No', 'Admin only'],
    ['Generate Reports', 'Yes', 'Yes', 'Yes', 'Yes', 'All roles'],
    ['Export to Excel', 'Yes', 'Yes', 'Yes', 'Yes', 'All roles'],
    ['My Active Tickets', 'Yes', 'Yes', 'Yes', 'Yes', 'All roles - Start/Finish tickets for properties'],
]
...
nav_data = [
    ...
    ['login.html', 'OAuth Login Success', 'UserDashboard.html', 'Subcontractor/User', 'Role-based redirect'],
    ...
    ['UserDashboard.html', 'My Active Tickets', 'MyTickets.html', 'Subcontractor/User', 'Navigation link'],
    ['UserDashboard.html', 'View Properties', 'PropertyInfo.html', 'Subcontractor/User', 'Navigation link'],
    ['UserDashboard.html', 'Submit Winter Log', 'WinterOpsLog.html', 'Subcontractor/User', 'Navigation link'],
    ['UserDashboard.html', 'Submit Green Log', 'GreenOpsLog.html', 'Subcontractor/User', 'Navigation link'],
]
